export default function Photoframes(){
    ...
    return(
        ...
        // <div><h1 className="text-center">Photo Frames</h1></div>
        //     <div className="row">       
        //     {obj.map((el)=>(               
        //         <div className="col-md-3">                  
        //             <div className="card mt-4 zoom" style={{width: "18rem;"}}>
        //             <img src={"/assets/images/Frames/Updated/"+`${el.img}`} className="card-img-top " alt="..." />
      ...
      <section className="contact py-lg-4 py-md-3 py-sm-3 py-3">
         <div className="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 className="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Photo Frames</h3>
            <div className="row">
